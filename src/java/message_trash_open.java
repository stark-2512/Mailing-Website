...
public class message_trash_open extends HttpServlet
{
    Connection co;
    ...
    public void doGet(HttpServletRequest req,HttpServletResponse rep)
    {
        ...
        try
        {
            ...
            ps=co.prepareStatement("select * from trash where id_num=?");
            ps.setInt(1,id);
            rs=ps.executeQuery();
            while(rs.next())
            {
...
"          <div class=\"u-container-layout u-container-layout-1\">");
            ...
            out.println("<h4 class=\"u-text u-text-custom-color-3 u-text-default u-text-2\">From :&nbsp;</h4>");
            
            out.println("<h4 class=\"u-text u-text-default u-text-3\">"+from+"&nbsp;</h4>");
