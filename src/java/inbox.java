...
public class inbox extends HttpServlet
{
    ...
    public void doGet(HttpServletRequest req,HttpServletResponse rep)
    {
        try
        {
            ...
            ps=co.prepareStatement("select * from inbox where mail_to=?");
...
"</li><li class=\"u-nav-item\"><a class=\"u-button-style u-nav-link\" href=\"About.html\" style=\"padding: 10px 60px;\">Home</a>\n" +
...
"          <form action=\"delete\" method=\"GET\" class=\"u-clearfix u-form-custom-backend u-form-spacing-10 u-form-vertical u-inner-form\" source=\"custom\" name=\"form\" style=\"padding: 10px;\" redirect=\"true\">\n" +
...
"                <a href=message_open?id="+rs.getString(1)+" class=\"u-active-none u-align-left u-border-2 u-border-palette-1-base u-btn u-btn-rectangle u-button-style u-hover-none u-none u-text-custom-color-4 u-text-hover-custom-color-3 u-btn-3\">"+rs.getString(2) +" : " +rs.getString(4)+"</a>\n" +
"              </label>\n" +
"            </div>");
