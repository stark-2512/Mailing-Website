...
public class message_open_sent extends HttpServlet
{
    Connection co;
    ...
    public void doGet(HttpServletRequest req,HttpServletResponse rep)
    {
        ...
        try
        {
            ...
            ps=co.prepareStatement("select * from sent where id_num=?");
            ps.setInt(1,id);
            rs=ps.executeQuery();
            while(rs.next())
            {
                msg_to=rs.getString(3);
                sub=rs.getString(4);
                body=rs.getString(5);
            }
...
"    <link rel=\"stylesheet\" href=\"nicepage4.css\" media=\"screen\">\n" +
"<link rel=\"stylesheet\" href=\"Message-Show.css\" media=\"screen\">\n" +
"    <script class=\"u-script\" type=\"text/javascript\" src=\"jquery4.js\" defer=\"\"></script>\n" +
"    <script class=\"u-script\" type=\"text/javascript\" src=\"nicepage4.js\" defer=\"\"></script>\n" +
...
"    <meta property=\"og:title\" content=\"Message Show\">\n" +
"    <meta property=\"og:type\" content=\"website\">\n" +
"  </head>\n" +
"  <body class=\"u-body\"><header class=\"u-clearfix u-custom-color-1 u-header u-sticky u-header\" id=\"sec-838e\"><div class=\"u-clearfix u-sheet u-sheet-1\">\n" +
...
"</li><li class=\"u-nav-item\"><a class=\"u-border-2 u-border-active-custom-color-4 u-border-hover-custom-color-3 u-button-style u-nav-link u-radius-27 u-text-active-custom-color-3 u-text-custom-color-4 u-text-hover-custom-color-3\" style=\"padding: 10px 72px;\">Message Show</a>\n" +
...
"</li><li class=\"u-nav-item\"><a class=\"u-border-2 u-border-active-custom-color-4 u-border-hover-custom-color-3 u-button-style u-nav-link u-radius-27 u-text-active-custom-color-3 u-text-custom-color-4 u-text-hover-custom-color-3\" href=\"Page-1.html\" style=\"padding: 10px 72px;\">Message Show</a>\n" +
"</li><li class=\"u-nav-item\"><a class=\"u-border-2 u-border-active-custom-color-4 u-border-hover-custom-color-3 u-button-style u-nav-link u-radius-27 u-text-active-custom-color-3 u-text-custom-color-4 u-text-hover-custom-color-3\" href=\"Page-1.html\" style=\"padding: 10px 72px;\">Message Show</a>\n" +
"</li></ul>\n" +
"          </div>\n" +
...
"</li><li class=\"u-nav-item\"><a class=\"u-button-style u-nav-link\" style=\"padding: 10px 72px;\">Message Show</a>\n" +
...
"                <ul class=\"u-align-center u-nav u-popupmenu-items u-unstyled u-nav-5\"><li class=\"u-nav-item\"><a class=\"u-button-style u-nav-link\" href=\"Home.html\" style=\"padding: 10px 60px;\">Settings</a>\n" +
...
"        </nav>\n" +
"      </div></header>\n" +
"    <section class=\"u-clearfix u-custom-color-1 u-section-1\" id=\"sec-7541\">\n" +
"      <div class=\"u-align-left u-clearfix u-sheet u-sheet-1\">\n" +
"        <h3 class=\"u-text u-text-custom-color-3 u-text-default u-text-1\">Message<br>\n" +
"        </h3>\n" +
"        <div class=\"u-border-3 u-border-custom-color-3 u-line u-line-horizontal u-line-1\"></div>\n" +
"        <div class=\"u-border-5 u-border-custom-color-3 u-container-style u-group u-radius-50 u-shape-round u-group-1\">\n" +
"          <div class=\"u-container-layout u-container-layout-1\">");
            
            out.println("<h4 class=\"u-text u-text-custom-color-3 u-text-default u-text-2\">To :&nbsp;</h4>");
            
            out.println("<h4 class=\"u-text u-text-default u-text-3\">"+msg_to+"&nbsp;</h4>");
            
            out.println("<h4 class=\"u-text u-text-custom-color-3 u-text-default u-text-4\">Subject :&nbsp;<br>\n" +
"            </h4>");
            
            out.println("<h4 class=\"u-text u-text-default u-text-5\">"+sub+"&nbsp;</h4>");
            
            out.println("<h4 class=\"u-text u-text-custom-color-3 u-text-default u-text-6\">Message :&nbsp;</h4>\n" +
"            <h4 class=\"u-text u-text-default u-text-7\">"+body+"</h4>\n" +
"          </div>\n" +
"        </div>\n" +
"      </div>\n" +
"    </section>\n" +
