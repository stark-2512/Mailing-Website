...
public class delete_draft extends HttpServlet
{
    Connection co;
    ...
    public void doGet(HttpServletRequest req,HttpServletResponse rep)
    {
        try
        {
            ...
            for (String resp : response) 
            {
                ...
                ps=co.prepareStatement("select * from draft where id_num=?");
                ...
                ps=co.prepareStatement("delete from draft where id_num=?");
                ps.setInt(1,Integer.parseInt(resp));
                ps.executeUpdate();
                ps.close();
