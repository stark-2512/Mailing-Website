...
public class draft extends HttpServlet
{
    ...
    public void doGet(HttpServletRequest req,HttpServletResponse rep)
    {
        try
        {
            ...
            ps=co.prepareStatement("select * from draft where mail_from=?");
...
"          <form action=\"delete_draft\" method=\"GET\" class=\"u-clearfix u-form-custom-backend u-form-spacing-10 u-form-vertical u-inner-form\" source=\"custom\" name=\"form\" style=\"padding: 10px;\" redirect=\"true\">\n" +
